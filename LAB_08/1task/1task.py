...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        original_image = pygame.image.load("goldcoin.png")
        self.image = pygame.transform.scale(original_image, (30, 30))
        self.rect = self.image.get_rect()
        self.reset()  # Initialize the coin position
    ...
    def move(self):
        ...
        if self.rect.top > SCREEN_HEIGHT:
            self.reset()  # If the coin has gone beyond the lower limit, we return it to the top
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, coins):
        ...
        pygame.sprite.spritecollideany(P1, coins).reset()   
